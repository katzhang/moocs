...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        result = False;
        storyContent = [];
        storyContent.append(story.getTitle());
        storyContent.append(story.getSubject());
        storyContent.append(story.getSummary());
        
        for field in storyContent:
            if self.isPhraseIn(field):
                result = True;
                break;
        return result;
